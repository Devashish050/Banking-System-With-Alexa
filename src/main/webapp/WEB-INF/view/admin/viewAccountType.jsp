...
<head>
  ...
  <title>BSWA | View Account Type</title>
  <!-- plugins:css -->
                  ...
                  <div class="table-responsive">
                    <table id="order-listing" class="table">
                      ...
                      <tbody>
                		...
                		<c:forEach items="${accountList}" var="i" varStatus="j">
                        <tr>
                            <td>${j.count}</td>
                            <td>${i.accountType}</td>
                            <td>${i.accountTypeDescription}</td>
                            <td><a class="btn btn-primary" href="editAccountType?id=${i.id}">Edit</a>&nbsp&nbsp<a class="btn btn-danger" href="deleteAccountType?id=${i.id}">Delete</a></td>
                        </tr>
                        </c:forEach>
                       </tbody>
                    </table>
