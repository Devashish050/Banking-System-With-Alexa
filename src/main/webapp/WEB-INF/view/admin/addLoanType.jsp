...
<head>
  ...
  <title>BSWA | Add Loan Type</title>
  <!-- plugins:css -->
            ...
            <div class="col-lg-12">
              <div class="card">
                <div class="card-body">
                  ...
                  <f:form class="cmxform"  method="post" action="insertLoanType" modelAttribute="LoanTypeVO">
                     <f:hidden path="id"/>
                    <fieldset>
                      <div class="form-group">
                        <label for="cname">Loan Type</label>
                        <f:input path="loanType" class="form-control" required="required"/>
                       
                       <!--  <input id="cname" class="form-control" name="name" minlength="2" type="text" required> -->
                      </div>
                      <div class="form-group">
                        <label for="ccomment">Loan Description</label>
                        <f:textarea rows="3" cols="3" path="loanTypeDescription" class="form-control" required="required"/>
