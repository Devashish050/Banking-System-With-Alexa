...
<head>
  ...
  <title>BSWA | Add Account Documents</title>
  <!-- plugins:css -->
  <link rel="stylesheet" href="<%=request.getContextPath()%><%=request.getContextPath()%>/adminResources/css/materialdesignicons.min.css">
  <link rel="stylesheet" href="<%=request.getContextPath()%><%=request.getContextPath()%>/adminResources/css/vendor.bundle.base.css">
  <link rel="stylesheet" href="<%=request.getContextPath()%><%=request.getContextPath()%>/adminResources/css/vendor.bundle.addons.css">
  <!-- endinject -->
...
<body>
         ...
         <%-- <div class="row grid-margin">
          ...
          <div class="row grid-margin">
            <div class="col-lg-12">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Add Account Documents</h4>
                  <%@taglib prefix="f" uri="http://www.springframework.org/tags/form"%>
        			<%@taglib prefix="i" uri="http://java.sun.com/jstl/core_rt" %>              
                  
                  <f:form class="cmxform"  method="post" action="insertAccountDocs" modelAttribute="AccountDocsVO" >
                    <fieldset>
                      <div class="form-group">
                        <label for="cname">A/c Type</label>
                        <f:hidden path="id"/>
                        <f:select class="form-control" path="accountTypeVO.id" required="required" select="selected">
                        <i:forEach var="i" items="${accountList}">
						<f:option value="${i.id}">${i.accountType}</f:option>
						</i:forEach>
						</f:select>
                      </div>
                      <div class="form-group">
                        <label for="cname">Required Docs</label>
                        <f:select class="form-control" path="docsVO.id" required="required" select="selected">
                        <i:forEach var="i" items="${docsList}">
						<f:option value="${i.id}">${i.docsName}</f:option>
						</i:forEach>
						</f:select>
                      </div>
  ...
  <!-- container-scroller -->
  <!-- plugins:js -->
  <script src="<%=request.getContextPath()%><%=request.getContextPath()%><%=request.getContextPath()%>/adminResources/js/vendor.bundle.base.js"></script>
  <script src="<%=request.getContextPath()%><%=request.getContextPath()%>/adminResources/js/vendor.bundle.addons.js"></script>
  <!-- endinject -->
  <!-- inject:js -->
  <script src="<%=request.getContextPath()%><%=request.getContextPath()%>/adminResources/js/off-canvas.js"></script>
  <script src="<%=request.getContextPath()%><%=request.getContextPath()%>/adminResources/js/hoverable-collapse.js"></script>
  <script src="<%=request.getContextPath()%><%=request.getContextPath()%>/adminResources/js/template.js"></script>
  <script src="<%=request.getContextPath()%><%=request.getContextPath()%>/adminResources/js/settings.js"></script>
  <script src="<%=request.getContextPath()%><%=request.getContextPath()%>/adminResources/js/todolist.js"></script>
  <!-- endinject -->
  <!-- Custom js for this page-->
  <script src="<%=request.getContextPath()%><%=request.getContextPath()%>/adminResources/js/form-validation.js"></script>
  <script src="<%=request.getContextPath()%><%=request.getContextPath()%>/adminResources/js/bt-maxLength.js"></script>
