...
<head>
  ...
  <title>BSWA | Add Documents</title>
  <!-- plugins:css -->
            ...
            <div class="col-lg-12">
              <div class="card">
                <div class="card-body">
                  ...
                  <f:form class="cmxform" method="post" action="insertRequiredDocs" modelAttribute="DocsVO">
                    <fieldset>
                      <div class="form-group">
                        <label for="cname">Doc Type</label>
                        <f:input path="docsName" class="form-control" required="required"/>  
                        <f:hidden path="id"/>                      
