...
<title>BSWA | View Account Documents</title>
<!-- plugins:css -->
<link rel="stylesheet"
		...
		<div class="container-fluid page-body-wrapper">
			...
			<div class="main-panel">
				<div class="content-wrapper">
					<div class="card">
						<div class="card-body">
							<h4 class="card-title">View Account Documents</h4>
							<div class="row">
								<div class="col-12">
									<div class="table-responsive">
										<table id="order-listing" class="table">
											...
											<tbody>
											<c:forEach items="${accountDocsList}" var="i" varStatus="j">
												<tr>
													<td>${j.count}</td> <!--  It will display serial num starting from one -->
													<td>${i.accountTypeVO.accountType}</td>
													<td>${i.docsVO.docsName}</td>
													<td><a class="btn btn-primary" href="editAccountDocs?id=${i.id}">Edit</a>&nbsp&nbsp<a class="btn btn-danger" href="deleteAccountDocs?id=${i.id}">Delete</a></td>
												</tr>
												</c:forEach>
											</tbody>
										</table>
