...
<head>
  ...
  <title>BSWA | Add Loan Documents</title>
  <!-- plugins:css -->
         ...
         <%-- <div class="row grid-margin">
          ...
          <div class="row grid-margin">
            <div class="col-lg-12">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Add Loan Documents</h4>
                   <%@taglib prefix="f" uri="http://www.springframework.org/tags/form"%>
        			<%@taglib prefix="i" uri="http://java.sun.com/jstl/core_rt" %>              
                  <f:form class="cmxform" method="post" action="insertLoanDocs" modelAttribute="LoanDocsVO">
                    <f:hidden path="id"/>
                    <fieldset>
                      <div class="form-group">
                        <label for="cname">Loan Type</label>
                         <f:select class="form-control" path="loanTypeVO.id" required="required" select="selected">
                        <i:forEach var="i" items="${loanList}">
                       ...
                       <div class="form-group">
                        <label for="cname">Document Type</label>
                         <f:select class="form-control" path="documentType" required="required" select="selected">
		                        <f:option value="IdProof">IdProof</f:option>
		                        <f:option value="ResidentProof">ResidentProof</f:option>
		                </f:select>        
					  </div>
                      
                      <div class="form-group">
                        <label for="cname">Required Documents</label>
