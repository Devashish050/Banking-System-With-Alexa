...
<head>
  ...
  <title>BSWA | Add Loan Rate</title>
  <!-- plugins:css -->
            ...
            <div class="col-lg-12">
              <div class="card">
                <div class="card-body">
                  ...
                  <f:form class="cmxform" method="post" action="insertLoanRate" modelAttribute="ManageLoanRateVO">
                    <fieldset>
                    <div class="form-group">
                        <label for="cname">Loan Type</label>
                        <f:select class="form-control" path="loanTypeVO.id" required="required">
                      ...
                      <div class="form-group">
                        ...
                        <f:input path="loanRate" class="form-control" required="required"/>
                        <f:hidden path="id"/>
                      </div>
                      <div class="form-group">
                        <label for="ccomment">Loan Rate Description</label>
                        <f:textarea rows="3" cols="3" path="loanRateDescription" class="form-control" required="required"/>
