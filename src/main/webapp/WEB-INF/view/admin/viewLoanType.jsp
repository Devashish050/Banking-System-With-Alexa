...
<title>BSWA | View Loan Type</title>
<!-- plugins:css -->
<link rel="stylesheet"
 ...
 -->			</div>
			...
			<div class="main-panel">
				<div class="content-wrapper">
					<div class="card">
						<div class="card-body">
							<h4 class="card-title">View Loan Type</h4>
							<div class="row">
								<div class="col-12">
										...
										<table id="order-listing" class="table">
											...
											<c:forEach items="${loanList}" var="i">
												<tr>
													...
													<td><a class="btn btn-primary" href="editLoanType?id=${i.id}">Edit</a>&nbsp&nbsp<a class="btn btn-danger" href="deleteLoanType?id=${i.id}">Delete</a></td>
												</tr>
												</c:forEach>
											</tbody>
										</table>
