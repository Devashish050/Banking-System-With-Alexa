...
<head>
  ...
  <title>BSWA | View Loan Rate</title>
  <!-- plugins:css -->
 ...
 -->      </div>
      ...
      <div class="main-panel">
        <div class="content-wrapper">
          <div class="card">
            <div class="card-body">
              <h4 class="card-title">View Loan Rate</h4>
              <div class="row">
                <div class="col-12">
                    ...
                    <table id="order-listing" class="table">
                      ...
                      <tbody>
                        ...
                        <tr>
                            ...
                            <td><a class="btn btn-primary" href="editLoanRate?id=${i.id}">Edit</a>&nbsp&nbsp<a class="btn btn-danger" href="deleteLoanRate?id=${i.id}">Delete</a></td>    
                        </tr>
                        </c:forEach>
                       </tbody>
                    </table>
