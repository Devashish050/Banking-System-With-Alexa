...
<title>BSWA | View Complaint</title>
<!-- plugins:css -->
<link rel="stylesheet"
										...
										<table id="order-listing" class="table">
											...
											<%@taglib prefix="c" uri="http://java.sun.com/jstl/core_rt"%>
												...
												<tr>
													...
													<td>${i.reply}</td>
													<td><a class="badge badge-info" href="<%=request.getContextPath()%>/documents/complaint/${i.fileName}" target="_blank">view</a></td>
													
													<td>
													<c:if test="${i.complainStatus eq 'pending' }">
                                                    					<a class="btn btn-primary" href="replytoUser?id=${i.complainId}">reply</a>
                                                    				</c:if>
