		...
		<div class="container-fluid page-body-wrapper">
			...
			<div class="main-panel">
				<div class="content-wrapper">
					<div class="card">
						<div class="card-body">
							<h4 class="card-title">View User Loan</h4>
							<div class="row">
								<div class="col-12">
											...
											<tbody>
												<c:forEach items="${userLoanList}" var="i" varStatus="j">
													<tr>
														...
														<td><a href="<%=request.getContextPath()%>/documents/applyloandocs/${i.loginVO.username}/${i.idProofFileName}"
															target="_blank">View</a></td>
														<td><a href="<%=request.getContextPath()%>/documents/applyloandocs/${i.loginVO.username}/${i.residentProofFileName}"
															target="_blank">View</a></td>
														<td>
															 <c:if test="${i.docStatus eq 'pending'}">
																<a href="approveLoan?id=${i.id}&email=${i.loginVO.username}&status=Approve"><i class="mdi mdi-checkbox-marked" style="color:green; font-size:30px;"></i></a>
																<a href="rejectLoan?id=${i.id}&email=${i.loginVO.username}&status=Reject"><i class="mdi mdi-close-box" style="color:red; font-size:30px;"></i></a>
															</c:if>
															
															 <c:if test="${i.docStatus eq 'Approve'}">
                                           						<span class="badge badge-success badge-pill">APPROVED</span>
                                           					 </c:if>
                                            
                                           					 <c:if test="${i.docStatus eq 'Reject'}">
