...
<head>
  ...
  <title>BSWA | View Documents</title>
  <!-- plugins:css -->
                  ...
                  <div class="table-responsive">
                    <table id="order-listing" class="table">
                      ...
                      <tbody>
                		...
                		<c:forEach items="${docsList}" var="i" varStatus="j">
                        <tr>
                            <td>${j.count}</td>
                            <td>${i.docsName}</td>
                            <td><a  class="btn btn-primary" href="editRequiredDocs?id=${i.id}">Edit</a>&nbsp&nbsp<a class="btn btn-danger" href="deleteRequiredDocs?id=${i.id}">Delete</a></td>
                        </tr>
                        </c:forEach>
                       </tbody>
                    </table>
