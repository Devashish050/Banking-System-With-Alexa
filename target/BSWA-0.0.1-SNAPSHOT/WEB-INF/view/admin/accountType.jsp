...
<head>
  ...
  <title>BSWA | Add AccounType</title>
  <!-- plugins:css -->
         ...
         <%-- <div class="row grid-margin">
          ...
          <div class="row grid-margin">
            <div class="col-lg-12">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title"> Add AccounType</h4>
                  
                   <%@taglib uri="http://www.springframework.org/tags/form" prefix="f" %>
                  
                  <f:form class="cmxform" method="post" action="insertAccountType" modelAttribute="AccountTypeVO">
                    <fieldset>
                      <div class="form-group">
                        <label for="cname">A/C Type</label>
                        <f:input path="accountType" class="form-control" required="required"/>  
                        <f:hidden path="id"/>                      
                      <!--   <input id="cname" class="form-control" name="name"  type="text" required> -->
                      </div>
                      <div class="form-group">
                        <label for="ccomment">A/c Type Description</label>
                        <f:textarea rows="3" cols="3" path="accountTypeDescription" class="form-control" required="required"/>
