...
<head>
  ...
  <title>BSWA | View Loan Documents</title>
  <!-- plugins:css -->
 ...
 -->      </div>
      ...
      <div class="main-panel">
        <div class="content-wrapper">
          <div class="card">
            <div class="card-body">
              <h4 class="card-title">View Loan Documents</h4>
              <div class="row">
                <div class="col-12">
                  <div class="table-responsive">
                    <table id="order-listing" class="table">
                      ...
                      <tbody>
                    <c:forEach items="${loanDocsList}" var="i" varStatus="j">
                        <tr>
                            <td>${j.count}</td>
                            <td>${i.loanTypeVO.loanType}</td>
                          	<td>${i.docsVO.docsName}</td>
                            <td><a class="btn btn-primary" href="editLoanDocs?id=${i.id}">Edit</a>&nbsp&nbsp<a class="btn btn-danger" href="deleteLoanDocs?id=${i.id}">Delete</a></td> 
                        </tr>
                        </c:forEach>
                       </tbody>
                    </table>
